...
class MainPage(Base):
    ...
    def get_search_field(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(('xpath', self.search_field)))

    def get_search_button(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(('xpath', self.search_button)))

    def get_search_result_word(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(('xpath', self.search_result_word)))

    def get_all_books_titles_locator(self):
        return WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(('xpath', self.all_books_titles_locator)))
